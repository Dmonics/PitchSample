...
const FText FAssetTypeActions_PaperZDAnimBP::CategoryDisplayName = FText::FromString("PaperZetaD");
...
void FAssetTypeActions_PaperZDAnimBP::OpenAssetEditor(const TArray<UObject*>& InObjects, TSharedPtr<IToolkitHost> EditWithinLevelEditor)
{
	...
	for (auto ObjIt = InObjects.CreateConstIterator(); ObjIt; ++ObjIt)
	{
		...
		if (AnimBP != NULL)
		{
			EditorModule->CreateAnimBPEditor(EToolkitMode::Standalone, EditWithinLevelEditor, AnimBP);
