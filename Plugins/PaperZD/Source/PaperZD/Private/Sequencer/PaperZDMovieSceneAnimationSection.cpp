...
FMovieSceneEvalTemplatePtr UPaperZDMovieSceneAnimationSection::GenerateTemplate() const
{
	return FPaperZDMovieSceneAnimationTemplate(*this);
}
...
UMovieSceneSection* UPaperZDMovieSceneAnimationSection::SplitSection(FQualifiedFrameTime SplitTime, bool bDeleteKeys)
{
	...
	{
		UPaperZDMovieSceneAnimationSection* NewSkeletalSection = Cast<UPaperZDMovieSceneAnimationSection>(NewSection);
...
#if WITH_EDITOR
void UPaperZDMovieSceneAnimationSection::PreEditChange(UProperty* PropertyAboutToChange)
{
